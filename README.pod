...
We need Mojolicious for CodeWars. Also we need Mojolicious::Plugin::Mail now 
L<http://search.cpan.org/~sharifuln/Mojolicious-Plugin-Mail-0.8/lib/Mojolicious/Plugin/Mail.pm>.
Thanks->to("Anatoly Sharifulin").
...
=head4 Also
    ...
    sudo aptitude install libmime-lite-perl liime-encwords-perl
